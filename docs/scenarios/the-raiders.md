...
_**A small attacking force has been sent in to cripple or destroy as much of
...
enabling the attacker’s main fleet to roam the system unhindered.**_
...
ships suffer a -1 [Leadership](../the-rules.md#leadership) penalty to
