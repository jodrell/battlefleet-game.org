...
_**A fleet has been trapped in the system for several months, unable to fight
...
return with sufficient reinforcements to lift the blockade totally.**_
...
in either the [outer reaches](../the-battlefield.md#5-outer-reaches-generator) or [deep space](../the-battlefield.md#6-deep-space-generator).
...
blockading player’s table edge. [Crippled](../the-shooting-phase.md#crippled-ships) ships
