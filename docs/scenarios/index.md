...
[fleet commanders](../fleet-lists/index.md#fleet-commander).

**Forces** tells you how to
pick your fleets, usually in
conjunction with the [Fleet
Lists](../fleet-lists/index.md). In some scenarios, one
...
assault](planetary-assault.md), using special Contact
...
win. Often [victory points](#victory-points)
